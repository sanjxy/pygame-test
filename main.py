...
YELLOW_SPACESHIP_RESIZE = pygame.transform.rotate(pygame.transform.scale(
    YELLOW_SPACESHIP, (SPACESHIP_HEIGHT, SPACESHIP_WIDTH)), 90)
RED_SPACESHIP = pygame.image.load(os.path.join('assets', 'spaceship_red.png'))
RED_SPACESHIP_RESIZE = pygame.transform.rotate(pygame.transform.scale(
    RED_SPACESHIP, (SPACESHIP_HEIGHT, SPACESHIP_WIDTH)), 270)
